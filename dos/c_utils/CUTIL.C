...
/* param_str ****************************************************************/
/*                                                                          */
/*  This function returns the parameter specified in dst.                   */
/*  Make sure you call param_str first.                                     */
/*                                                                          */
/*************************************************** Doug Rogers 1989.03.10 */
char *param_str (char *s,int param,char *dst)
{
  return (sub_str (s,param_pos[param],param_len[param],dst));
}   /*param_str*/
